...
There is two tests for tagging including a positive functional test to ensure you can add tagged items and another edge case that checks for invalid tags
